...
public class Level3 extends javax.swing.JFrame {
    ...
    public void igual(){
            if(pontuacao==3890){ //3930, pontuacao aumenta +20, +110 bônus
            pontuacao+=110;
            JOptionPane.showMessageDialog(rootPane, "Parabéns você zerou o campo minado!!!");
            this.dispose();
            pt.setVisible(true);
            try {
...
"where id = (select max(id) from pontos)");
    ...
    private void initComponents() {
        ...
        setTitle("Campo Minado - Nível 3 (Máximo)");
        setResizable(false);
